...
namespace Utkaka.ScaleNineSlicer.Editor.SpriteSlicing.Window
{
    public class BordersEditor
    {
        ...
        public BordersEditor(VisualElement root)
        {
            ...
            borderWindow
                .Q<Button>(name: "Detect")
                .RegisterCallback<ClickEvent>(OnDetectBorderClick);
        ...
        public void SetSpriteInfo(SpriteInfo spriteInfo)
        {
            ...
            backgroundImage.value = new Background
            {
                sprite = _spriteInfo.CreateSprite(FilterMode.Point, int4.zero),
            };
        ...
        private void OnPointerMove(PointerMoveEvent evt)
        {
            ...
            pixelPosition =
                new Vector3(Mathf.Round(pixelPosition.x), Mathf.Round(pixelPosition.y)) * _scale;
            var value = 0;
        ...
        {
            if (evt.currentTarget is not VisualElement guide)
                return;
        ...
        private void SetScale(float value)
        {
            ...
            _scale = value;
            _imageSize = new int2(
                Mathf.RoundToInt(_spriteInfo.Width * _scale),
                Mathf.RoundToInt(_spriteInfo.Height * _scale)
            );
